...
public class NetPhysics_client : ModuleRules
{
    //Path of this module
	...
	public NetPhysics_client(TargetInfo Target)
	{
        ...
        PrivateIncludePaths.Add(Path.Combine(ModulePath, "../../../NetPhysics_server/Source/XSource"));
        //Loads RakNet
        LoadRakNet(Target);
